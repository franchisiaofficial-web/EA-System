...
export async function POST(
  ...
  try {
    ...
    await requirePermission(authCtx, 'staff', 'reactivate');

    const result = await reactivateStaff(authCtx, id);
    ...
    console.error('POST /api/staff/members/[id]/reactivate error:', e);
