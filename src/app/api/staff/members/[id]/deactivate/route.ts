...
export async function POST(
  ...
  try {
    ...
    await requirePermission(authCtx, 'staff', 'deactivate');

    const result = await deactivateStaff(authCtx, id);
    ...
    console.error('POST /api/staff/members/[id]/deactivate error:', e);
